...
# Uses OIDC authentication with account_id 533269020590 from env.json
# Updated workflow with fixed artifact download handling
terraform {
  source = "../../module"
}
...
locals {
  ...
  # Example: prod-us-east-1-myproject-access-log-bucket
